...
(0, _ava2.default)('basic evaluation with exception', t => {
  ...
  const evaluate = val => {
    ...
    if (val.value.constructor === Div) {
      return evaluate(val.value.term1).then(a => evaluate(val.value.term2).then(b => b === 0 ? _main.MonadicException.raise('Division by zero') : _main.MonadicException.unit(a / b)));
    }
  };
  ...
  t.is(_rec16._expr(_rec16._capt(_rec16._capt(_rec16._capt(errorResult, 'arguments/0/object/object').value, 'arguments/0/object').error, 'arguments/0'), {
    content: 't.is(errorResult.value.error, \'Division by zero\')',
    filepath: 'test/main.js',
    line: 70,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"is","range":[2,4]},"computed":false,"range":[0,4]},"arguments":[{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"errorResult","range":[5,16]},"property":{"type":"Identifier","name":"value","range":[17,22]},"computed":false,"range":[5,22]},"property":{"type":"Identifier","name":"error","range":[23,28]},"computed":false,"range":[5,28]},{"type":"StringLiteral","value":"Division by zero","range":[30,48]}],"range":[0,49]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"is","range":[2,4]},{"type":{"label":"("},"range":[4,5]},{"type":{"label":"name"},"value":"errorResult","range":[5,16]},{"type":{"label":"."},"range":[16,17]},{"type":{"label":"name"},"value":"value","range":[17,22]},{"type":{"label":"."},"range":[22,23]},{"type":{"label":"name"},"value":"error","range":[23,28]},{"type":{"label":","},"range":[28,29]},{"type":{"label":"string"},"value":"Division by zero","range":[30,48]},{"type":{"label":")"},"range":[48,49]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), 'Division by zero');
});
//# sourceMappingURL=../node_modules/.cache/ava/88c06ad63e558a167a1a6e06273eceea.js.map