...
(0, _ava2.default)('basic evaluation with exception', t => {
  ...
  t.throws(_avaThrowsHelper(function () {
    return _ => evaluate(new Term(new Div(new Term(10), new Term(0))));
  }, {
    line: 67,
    column: 11,
    source: '_ => evaluate(new Term(new Div(new Term(10), new Term(0))))',
...
//# sourceMappingURL=../node_modules/.cache/ava/2fdf55b2dac3f3ea5f17a31dc098169d.js.map